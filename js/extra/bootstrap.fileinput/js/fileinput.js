...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-default glyphicon glyphicon-trash',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-open',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-zoom-in',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="glyphicon glyphicon-zoom-in"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-zoom-in',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-resize-vertical',
            fullscreen: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-fullscreen',
            borderless: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-resize-full',
            close: 'btn btn-sm btn-kv btn-default glyphicon glyphicon-remove'
        },
        previewTemplates: {},
        previewContentTemplates: {},
